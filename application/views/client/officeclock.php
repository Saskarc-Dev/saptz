<div class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item dropdown" id="navlinks">
    ...
    <div id="ofcalert" class="mb-3 mt-3"></div>
    <div class="container" style="margin-top:3px; height: 500px;">
        <div style="height: 350px; height: 350px; border: 1px solid black; background-image: url('../assets/img/ind-2.jpg'); background-size:cover; background-repeat: no-repeat; margin: 15%; margin-left: 5%; margin-right: 5%; border-radius: 10px;">
            <div class="row align-items-center" style="margin-top:8%; margin-left:5%; margin-right:5%;">
                <div class="col-md-4" style="text-align:center;">
                    <!-- <div class="rounded-circle" style="height: 200px; width: 200px; border: 1px solid whitesmoke; background-image: url('https://picsum.photos/200/300')"></div> -->
                    <div class="rounded-circle" style="height: 200px; width: 200px; border: 1px solid whitesmoke; background-image: url('/assets/img/user-icon.png'); background-size: contain;"></div>
                </div>
                <div id="logctrl" class="col" style="text-align:center;">
                </div>
            </div>
        </div>
    </div>    
