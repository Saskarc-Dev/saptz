<div class="container-fluid">
    ...
    <div class="container-fluid pb-2" style="background-image: url('../assets/img/gradient-3.jpg'); background-size:cover; background-repeat: no-repeat; height: auto;">
        <h5>
            <span class="fa-stack fa-2x mt-2" >
                <i class="fas fa-square fa-stack-2x fa-inverse"></i>
                <i class="fas fa-tools fa-stack-1x"></i>
            </span>
            <label style="color:whitesmoke;">My Jobsheet</label> 
        </h5>
            ...
            <div class="row mb-2">
                <div class="col-sm mb-1">
                    <div class="input-group input-group-sm mb-1 mt-1">
                        ...
                        <input id="jsstart" name="jsstart" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" style="width:90px !important;">
                    </div>
                </div>
                <div class="col-sm mb-1">
                    <div class="input-group input-group-sm mb-1 mt-1">
                        ...
                        <input id="jsend" name="jsend" type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" style="width:90px !important;">
                    </div>
                </div>
                <div class="col-sm mb-1">
                    <button id="btnjsload" class="btn btn-md btn-outline-light">Load</button>
                </div>
                <div class="col-sm mb-1"></div>
            </div>           
        </div>
        <div class="container-fluid mb-1" style="border: 1px solid whitesmoke; border-radius: 10px;">
            <h5 class="mt-2" style="color:whitesmoke;">Job Logs</h5>
            <table id="myjs" class="table table-bordered" style="width:100%; height: inherit; font-size: 12px !important; color:white; height: 90%;">
                <thead>
                    <tr>
                        <td align="center" style="font-size: 12px !important; font-weight:bold !important;">Work Date</th>
                        <td align="center" style="font-size: 12px !important; font-weight:bold !important;">Work Center</th>
                        <td align="center" style="font-size: 12px !important; font-weight:bold !important;">Activity</th>
                        <td align="center" style="font-size: 12px !important; font-weight:bold !important;">Order No.</th>
                        <td align="center" style="font-size: 12px !important; font-weight:bold !important;">Job No.</th>
                        <td align="center" style="font-size: 12px !important; font-weight:bold !important;">Time Start</th>
                        <td align="center" style="font-size: 12px !important; font-weight:bold !important;">Time End</th>
                        <td align="center" style="font-size: 12px !important; font-weight:bold !important;">Cycle Hrs.</th>
                        <!-- <td align="center" style="font-size: 12px !important; font-weight:bold !important;">Unassigned Time</th> -->
                    </tr>
                </thead>
                <tbody id="myjsdata"></tbody>
                <tfoot>
                    <tr>
                        <td colspan="7" style="font-size: 12px !important; font-weight:bold !important;">Jobsheet Totals (Hours)</th>
